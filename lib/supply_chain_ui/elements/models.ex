defmodule SupplyChainUi.Model do
  ...
  def code_preview(assigns) do
    assigns =
      assign_new(assigns, :title, fn -> "Code" end)
      |> assign_new(:code, fn -> "{}" end)
      |> assign_new(:return_to, fn -> "close_code_preview_model" end)
  ...
  def confirmation_model(assigns) do
    assigns =
      assign_new(assigns, :reject_text, fn -> "Cancel" end)
      |> assign_new(:params, fn -> "" end)
      |> assign_new(:agree_text, fn -> "Proceed" end)
      |> assign_new(:reject_function, fn -> "reject" end)
