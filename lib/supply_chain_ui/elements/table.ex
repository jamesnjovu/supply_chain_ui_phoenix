defmodule SupplyChainUi.Table do
  use Phoenix.Component
  import Phoenix.HTML.Form
  import SupplyChainUi.Gettext
  alias SupplyChainUi.PaginationComponent
  ...
  def done_sidebar_data(assigns) do
    ~H"""
    <div class="h-screen w-full flex flex-col justify-center items-center">
      <svg class="h-20" viewBox="-4.73 0 72.44 72.44" xmlns="http://www.w3.org/2000/svg" fill="#00FF00"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="Group_11" data-name="Group 11" transform="translate(-482.502 -412.731)"> <path id="Path_25" data-name="Path 25" d="M533.566,429.163l-25.9,25.9-8.182-8.182" fill="none" stroke="#00FF00" stroke-miterlimit="10" stroke-width="3"></path> <g id="Group_9" data-name="Group 9" opacity="0.15"> <circle id="Ellipse_17" data-name="Ellipse 17" cx="29.992" cy="29.992" r="29.992" transform="translate(484.002 423.686)" fill="none" stroke="#00FF00" stroke-linecap="round" stroke-miterlimit="10" stroke-width="3"></circle> </g> <g id="Group_10" data-name="Group 10"> <circle id="Ellipse_18" data-name="Ellipse 18" cx="29.992" cy="29.992" r="29.992" transform="translate(484.002 414.231)" fill="none" stroke="#00FF00" stroke-miterlimit="10" stroke-width="3"></circle> </g> </g> </g></svg>
      <div class="bg-[#5561E5] text-white px-2 text-md rounded rotate-12 absolute">
        <%= @message %>
      </div>
    </div>
  ...
  def iSearch(assigns) do
    assigns =
      assign_new(assigns, :params, fn -> %{"filter" => %{"isearch" => ""}} end)
    ...
    ~H"""
      <form class="max-w-sm" phx-change="iSearch">
        <div class="pb-2 relative formkit-field">
          ...
          <input type="search" class="formkit-input bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value={@params["filter"]["isearch"]} name="isearch" placeholder="Search..." aria-describedby="basic-addon3">
        </div>
      </form>
    """
  end
  ...
  defp empty_table(assigns) do
    assigns =
      assign_new(assigns, :data_loader, fn -> true end)
    ~H"""
  ...
  def table_numeric_status(assigns) do
    assigns =
      assign_new(assigns, :status, fn -> 1 end)
    ~H"""
      <div>
        <%= if @status == 1 do %>
